...
import os, uuid, io, qrcode, threading, webbrowser
...
USER_TABLE = os.getenv("USER_TABLE", "MovieMagicUsers")
BOOKING_TABLE = os.getenv("BOOKING_TABLE", "MovieMagicBookings")
SNS_TOPIC_ARN = os.getenv("SNS_TOPIC_ARN", "arn:aws:sns:us-east-1:604665149129:fixitnow_Topic")
